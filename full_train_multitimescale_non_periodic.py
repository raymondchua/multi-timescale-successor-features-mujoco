...
from modulators import NoisyAPeriodicSineModulator
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.mass_mod = NoisyAPeriodicSineModulator(
            period=250_000,
            phase=0.0,
            seed=1,
        ...
        self.friction_mod = NoisyAPeriodicSineModulator(
            period=250_000,
            phase=0.0,
            seed=2,
        ...
        self.forward_backwards_mod = NoisyAPeriodicSineModulator(
            period=250_000,
            phase=0.0,
            seed=3,
    ...
    def train(self):
        ...
        mass_vals, friction_vals, forward_backward_vals = [], [], []

        for _ in range(self.cfg.num_train_frames):
            mass_vals.append(self.mass_mod.sample())
            friction_vals.append(self.friction_mod.sample())
            forward_backward_vals.append(self.forward_backwards_mod.sample())
        ...
        for exposure_id in range(self.cfg.num_exposures):
            ...
            for task_id in range(self.num_tasks):
                ...
                mass_scale = mass_vals[self._global_step]
                friction_scale = friction_vals[self._global_step]
                forward_scale = forward_backward_vals[self._global_step]
...
def main(cfg):
    from full_train_multitimescale_non_periodic import Workspace as W
