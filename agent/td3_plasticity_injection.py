...
class TD3_plasticity_injection_Agent(TD3Agent):
    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            next_h = self.critic_encoder_target(next_obs, next_action)
            target_Q1, target_Q2 = self.critic_head_target(next_h)
        ...
        h = self.critic_encoder(obs, action)
        Q1, Q2 = self.critic_head(h)
        if plasticity_injection:
            Q1_random_1, Q2_random_1 = self.critic_head_random1(h)
            Q1_random_2, Q2_random_2 = self.critic_head_random2(h)
