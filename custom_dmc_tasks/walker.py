...
def modify_walker_dynamics(physics, mass_scale=1.0, friction_scale=1.0):
...
class PlanarWalker(base.Task):
    ...
    def get_reward(self, physics):
        ...
        if self._flip:
            ...
            move_reward = rewards.tolerance(
                self._forward_scale * physics.horizontal_velocity(),
