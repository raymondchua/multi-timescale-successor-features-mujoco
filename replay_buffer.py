    ...
    def add(self, time_step, meta):
        ...
        for spec in self._data_specs:
            if spec.name == "observation":
                # metaworld envs have a different observation structure
                if self._env_type == "metaworld":
                    value = time_step.observation["observation"]
                else:
                    value = time_step.observation
            elif spec.name == "success":
                value = (
                    time_step.observation["success"]
                    if "success" in time_step.observation
                    and time_step.observation["success"] is not None
